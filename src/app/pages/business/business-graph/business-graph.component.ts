...
@Component({
  selector: 'app-business-graph',
  templateUrl: './business-graph.component.html',
  styleUrl: './business-graph.component.css'
})
export class BusinessGraphComponent  implements OnInit, AfterViewInit{
